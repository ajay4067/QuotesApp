...
class UtilHandler {
    ...
    public function sendVerificationEmail($email, $timeStamp) {
        ...
        $base_url = 'http://jaagar.org/quotes/v1.2/activateUser/';
        ...
        $mail->Body = '<p>Hi, your account was created at ' 
                . $timeStamp . '. Please verify your email and get started using your Website account.'
                . '<br/><br/><a href="' . $base_url . $emailHash . '/' . $timestampMd5 . '">' 
                . $base_url . $emailHash . '/' . $timestampMd5 . '</a></p>';
    ...
    public function sendResetEmail($email, $resetId) {
        $base_url = 'http://jaagar.org/quotes/v1.2/forgotPswd/resetPermission/';
        $mail = $this->getMailHandller();
        $mail->addAddress($email);
        $mail->addReplyTo('ajmore.biz@gmail.com', 'Information');
        ...
        $mail->Body = '<p>Hi, You have requested us to reset your password.' .
                ' Please click the link to reset your password.' . '<br/><br/><a href="' 
                . $base_url . $email . '/' . $resetId . '">' . $base_url . $email . '/' 
                . $resetId . '</a></p>';
        $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
